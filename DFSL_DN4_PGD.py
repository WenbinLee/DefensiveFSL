...
parser.add_argument('--method_name', default='SKL', help=' AT | KL | ALP | Local_UDA | KLD | TCD | SKL')
parser.add_argument('--method_weight', type=float, default=0.01, help='the hyper-parameter of each method')
parser.add_argument('--version', default='PGD', help='set the version of the current experiment')
parser.add_argument('--mode', default='train', help='train|val|test')
parser.add_argument('--outf', default='./results_2023_06_06')
...
#  Attack parameters  #
parser.add_argument('--attack_mode', default='PGD', help='FGSM|PGD')
...
if __name__=='__main__':
	...
	print('\nDeepfool-Mean_accuracy: %f h: %f' %(total_accuracy/repeat_num, total_h.mean()))
	print('\nDeepfool-Mean_accuracy: %f h: %f' %(total_accuracy/repeat_num, total_h.mean()), file=F_txt_test)
	print('Deepfool-Mean_accuracy: %f h: %f Epsilon: %f' %(total_accuracy_attack/repeat_num, total_h_attack.mean(), epsilon))
	print('Deepfool-Mean_accuracy: %f h: %f Epsilon: %f' %(total_accuracy_attack/repeat_num, total_h_attack.mean(), epsilon), file=F_txt_test)
	print('Deepfool-Mean_F1: %f h: %f Epsilon: %f' %(total_accuracy_F1/repeat_num, total_h_F1.mean(), epsilon))
	print('Deepfool-Mean_F1: %f h: %f Epsilon: %f' %(total_accuracy_F1/repeat_num, total_h_F1.mean(), epsilon), file=F_txt_test)

	print('===================================== Deepfool Test is END =====================================\n')
	print('===================================== Deepfool Test is END =====================================\n', file=F_txt_test)
	...
	print('\nCW-Mean_accuracy: %f h: %f' %(total_accuracy/repeat_num, total_h.mean()))
	print('\nCW-Mean_accuracy: %f h: %f' %(total_accuracy/repeat_num, total_h.mean()), file=F_txt_test)
	print('CW-Mean_accuracy: %f h: %f Epsilon: %f' %(total_accuracy_attack/repeat_num, total_h_attack.mean(), epsilon))
	print('CW-Mean_accuracy: %f h: %f Epsilon: %f' %(total_accuracy_attack/repeat_num, total_h_attack.mean(), epsilon), file=F_txt_test)
	print('CW-Mean_F1: %f h: %f Epsilon: %f' %(total_accuracy_F1/repeat_num, total_h_F1.mean(), epsilon))
	print('CW-Mean_F1: %f h: %f Epsilon: %f' %(total_accuracy_F1/repeat_num, total_h_F1.mean(), epsilon), file=F_txt_test)

	print('===================================== C&W Test is END =====================================\n')
	print('===================================== C&W Test is END =====================================\n', file=F_txt_test)
